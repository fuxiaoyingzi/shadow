...
public class DisableDaysActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add a second decorator that explicitly enables days <= 10. This will work because decorators are applied in order, and the system allows re-enabling
    ...
    private static class EnableOneToTenDecorator implements DayViewDecorator {
        ...
        @Override
        public boolean shouldDecorate(CalendarDay day) {
            return day.getDay() <= 10; //点击的条件
        }

        @Override
        public void decorate(DayViewFacade view) {
            view.setDaysDisabled(false); //让view可以点击
        }
    }
}
