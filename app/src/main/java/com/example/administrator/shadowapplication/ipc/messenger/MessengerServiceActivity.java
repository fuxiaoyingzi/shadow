...
public class MessengerServiceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.bindService).setOnClickListener(v -> bindService());
    }
    ...
    public void bindService(){
        connection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
               ...
               bundle.putString("hh","hello service,hello shadow");
     ...
     class MyHandle extends Handler{
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 1:
                    if (msg.getData() != null){
                        String serviceSend = msg.getData().getString("hh");
                        Log.d("hh",serviceSend);
                        ToastUtil.showMsg(serviceSend);
                    }
                    break;
                    default:
                        ToastUtil.showMsg("客户端什么也没有收到");
